...
public class PathLoader {
    ...
    public void addMarriagePoint(int col, int row) {
        pathPoints.add(BoardNode.marriageNode(col, row));
    }
    ...
    private void c3SharedPath2() {
        addMarriagePoint(48, 27); // wedding tile
        addPoint(48, 30);
        addPoint(51, 30);
        addPoint(53, 30);
        addPoint(55, 30);//pink
